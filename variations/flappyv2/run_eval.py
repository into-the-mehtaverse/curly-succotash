...
Run from repo root:
  ...
  uv run python -m variations.flappyv2.run_eval
  uv run python -m variations.flappyv2.run_eval --model variations/flappyv2/experiments/<run_id>/model_009765.pt
  uv run python -m variations.flappyv2.run_eval --episodes 50 --no-render
  uv run python -m variations.flappyv2.run_eval --difficulty 0.5   # test at mid-curriculum
...
from variations.flappyv2 import curriculum_env_creator
from variations.flappyv2.train import make_flappyv2_lstm_policy
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to checkpoint .pt (default: latest in variations/flappyv2/experiments/)",
    )
    ...
    policy = make_flappyv2_lstm_policy(driver).to(args.device)
